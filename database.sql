...
CREATE TABLE personalization (personalization_id INT(20) NOT NULL AUTO_INCREMENT, image_1 VARCHAR(200), image_2 VARCHAR(200), image_3 VARCHAR(200), image_4 VARCHAR(200), image_5 VARCHAR(200), image_6 VARCHAR(200), image_7 VARCHAR(200), image_8 VARCHAR(200), image_9 VARCHAR(200), image_10 VARCHAR(200), PRIMARY KEY (personalization_id));
